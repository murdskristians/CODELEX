...
function () {
  ...
  Game.prototype.isWinningCombination = function (x, y, z) {
  ...
  Game.prototype.getWinner = function () {
    ...
    if (this.isWinningCombination(6, 7, 8)) return this.cells[6]; //Columns

    if (this.isWinningCombination(0, 3, 6)) return this.cells[0];
    if (this.isWinningCombination(1, 4, 7)) return this.cells[1];
    if (this.isWinningCombination(2, 5, 8)) return this.cells[2]; //Diagonals

    if (this.isWinningCombination(0, 4, 8)) return this.cells[0];
    if (this.isWinningCombination(2, 4, 6)) return this.cells[2]; //No Winner
